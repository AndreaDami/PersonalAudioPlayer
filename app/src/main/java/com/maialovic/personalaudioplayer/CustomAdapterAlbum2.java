 ...
 */
public class CustomAdapterAlbum2 extends ArrayAdapter<String> {
    // View lookup cache
    ...
    final ArrayList<String> singer;
    final String tmp_sing ;

    public CustomAdapterAlbum2(Context context, ArrayList<String> users, String sing) {
        super(context, R.layout.rowlayout2, users);
        singer = new ArrayList<String>(users);
        tmp_sing = sing;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        while (Player.songs_sorted_album.get(pos2).getmAlbum().compareTo( user ) == 0  && Player.songs_sorted_album.get(pos2).getmAuthor().compareTo(tmp_sing) == 0){
            cont++;
...
//        viewHolder.info.setText(Player.songs.get(last).getmAuthor() + " - " + cont + " songs");
//        viewHolder.info.setTextSize(18);
//        viewHolder.Name.setTextSize(18);
